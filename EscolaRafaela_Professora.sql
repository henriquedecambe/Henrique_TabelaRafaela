...
--
-- Host: 127.0.0.1    Database: EscolaRafaela
-- ------------------------------------------------------
...
CREATE TABLE `Professora` (
  `Nome_Professora` varchar(20) NOT NULL,
  `Idade_P` int NOT NULL,
  `Telefone_professora` varchar(15) NOT NULL,
  `CPF` varchar(11) NOT NULL,
  `Formação` varchar(10) NOT NULL,
  `Salário` varchar(10) NOT NULL,
...
-- Dump completed on 2025-10-08 11:49:23
